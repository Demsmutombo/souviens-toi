<template>
  <div class="min-h-screen bg-bg-cream">
    ...
    <section class="relative bg-gradient-to-br from-primary-ocre to-primary-gold text-white overflow-hidden hero-section">
      <div class="absolute inset-0 bg-black opacity-20"></div>
      <div class="relative container mx-auto px-4 py-16 sm:py-20 lg:py-32">
        <div class="text-center mb-12 sm:mb-16">
          <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4 sm:mb-6 leading-tight">
            Voix<br>
            <span class="text-yellow-200">Les Témoins de la Grâce</span>
          </h1>
          <div class="text-xl sm:text-2xl md:text-3xl font-serif mb-6 sm:mb-8 text-yellow-100">
            Des vies transformées par la puissance divine
          </div>
          <p class="text-base sm:text-lg md:text-xl mb-8 sm:mb-12 text-gray-100 leading-relaxed max-w-4xl mx-auto px-4">
      ...
      <div class="absolute bottom-0 left-0 right-0">
        <svg class="w-full h-8 sm:h-12 text-bg-cream" viewBox="0 0 1440 48" fill="currentColor">
    ...
    <!-- Featured Testimony -->
    <section class="py-12 sm:py-16 lg:py-20 bg-bg-cream">
      <div class="container mx-auto px-4">
        <div class="text-center mb-12 sm:mb-16">
          <h2 class="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold mb-4 sm:mb-6 text-primary-gold">
            Notre Pasteur
          </h2>
          <div class="w-16 sm:w-24 h-1 bg-primary-gold mx-auto mb-4 sm:mb-6"></div>
          <p class="text-base sm:text-lg text-text-secondary max-w-3xl mx-auto">
        ...
        <div class="max-w-4xl mx-auto">
          <div class="bg-white rounded-lg shadow-lg p-6 sm:p-8 mobile-optimized">
            <div class="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
              ...
              <div class="lg:w-2/3 w-full">
                <h3 class="text-xl sm:text-2xl font-bold text-primary-gold mb-4">
                  Transmettre aux Générations Futures
                </h3>
                <div class="text-gray-700 leading-relaxed space-y-4 text-justify text-sm sm:text-base">
                  <p>
                  ...
                  <blockquote class="border-l-4 border-primary-gold pl-4 italic text-text-secondary text-sm">
                  ...
                  <p class="text-right font-semibold text-primary-gold text-sm sm:text-base">
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-primary-ocre/10 to-primary-gold/10">
      <div class="container mx-auto px-4">
        <div class="text-center mb-12 sm:mb-16">
          <h2 class="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold mb-4 sm:mb-6 text-primary-gold">
            Le Moment Historique
        ...
        <div class="max-w-4xl mx-auto">
          <div class="bg-white rounded-lg shadow-lg overflow-hidden mobile-optimized">
            <div class="flex flex-col lg:flex-row items-center">
              ...
              <div class="lg:w-1/2 w-full p-6 sm:p-8">
                ...
                <h4 class="text-lg sm:text-xl font-semibold text-text-secondary mb-4">
                  Le Prophète du Temps de la Fin
                </h4>
                <p class="text-sm sm:text-base text-primary-gold font-semibold mb-4">
                ...
                <blockquote class="border-l-4 border-primary-gold pl-4 italic text-text-secondary text-sm sm:text-base">
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-bg-cream">
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto mb-12 sm:mb-16">
          <div class="bg-white rounded-lg p-6 sm:p-8 shadow-lg mobile-optimized">
            <div class="flex items-center mb-6">
              <div class="w-12 h-12 sm:w-16 sm:h-16 bg-primary-gold/20 rounded-full flex items-center justify-center mr-4">
                <i class="fas fa-microphone-alt text-primary-gold text-xl sm:text-2xl"></i>
              </div>
              <div>
                <h3 class="text-xl sm:text-2xl font-serif font-bold text-primary-gold mb-2">Témoignages Audio</h3>
                <p class="text-text-secondary text-sm sm:text-base">Écoutez les voix de ceux dont les vies ont été transformées</p>
              </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          <!-- Pasteur Bitwa -->
          <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 mobile-optimized">
            <div class="p-4 sm:p-6">
              <div class="text-center mb-4">
                <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full overflow-hidden mb-3 sm:mb-4 border-4 border-primary-gold/20">
                  <img src="/temoignage/bitwa.jpg" alt="Pasteur Bitwa" class="pastor-image">
                </div>
                <h3 class="text-lg sm:text-xl font-serif font-bold text-primary-gold mb-2">Pasteur Bitwa</h3>
                <p class="text-text-secondary text-sm mb-4">Serviteur de Dieu</p>
              </div>
              
              <div class="bg-gradient-to-r from-primary-gold/10 to-primary-ocre/10 rounded-lg p-3 sm:p-4">
                <div class="flex items-center mb-2">
                  <i class="fas fa-headphones text-primary-gold mr-2 text-sm sm:text-base"></i>
                  <span class="text-xs sm:text-sm font-semibold text-primary-gold">Témoignage Audio</span>
                </div>
                <audio controls class="w-full h-8 sm:h-10">
          ...
          <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="p-6">
              <div class="text-center mb-4">
                <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full overflow-hidden mb-3 sm:mb-4 border-4 border-primary-gold/20">
                  <img src="/temoignage/bala.jpg" alt="Pasteur Balanganayi" class="pastor-image">
                </div>
                <h3 class="text-lg sm:text-xl font-serif font-bold text-primary-gold mb-2">Pasteur Balanganayi</h3>
                <p class="text-text-secondary text-sm mb-4">Serviteur de Dieu</p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="p-6">
              <div class="text-center mb-4">
                <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full overflow-hidden mb-3 sm:mb-4 border-4 border-primary-gold/20">
                  <img src="/temoignage/kayumbi.gif" alt="Pasteur Kayumbi" class="pastor-image">
                </div>
                <h3 class="text-lg sm:text-xl font-serif font-bold text-primary-gold mb-2">Révérend Kayumbu Be Ya Leonard</h3>
                <p class="text-text-secondary text-sm mb-4">Guide spirituel - ZOE Tabernacle</p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="p-6">
              <div class="text-center mb-4">
                <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full overflow-hidden mb-3 sm:mb-4 border-4 border-primary-gold/20">
                  <img src="/temoignage/yves.jpg" alt="Frère Yves" class="pastor-image">
                </div>
                <h3 class="text-lg sm:text-xl font-serif font-bold text-primary-gold mb-2">Yves Kalombo</h3>
                <p class="text-text-secondary text-sm mb-4">Guide spirituel de l'église Logos Tabernacle de Kinshasa</p>
              </div>
...
/* Forcer les images à remplir le cercle */
.pastor-image {
  width: 100% !important;
